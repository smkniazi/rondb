...
typedef enum {
  ...
  ERROR_SCAN_FILTER_MISSING_OP          = 78,
  ERROR_SCAN_FILTER_LOGIC_MISSING_FILTERS     = 79,
  ERROR_SCAN_FILTER_LOGIC_INVALID_CHILD_TYPE  = 80,
  ERROR_SCAN_FILTER_LOGIC_INVALID_CHILD_NUM  = 81,
  ERROR_SCAN_FILTER_CMP_MISSING_COLUMN  = 82,
  ERROR_SCAN_FILTER_CMP_MISSING_COND  = 83,
  ERROR_SCAN_FILTER_CMP_MISSING_VALUE  = 84,
  ERROR_SCAN_FILTER_ISNULL_MISSING_COLUMN  = 85,
  ERROR_SCAN_FILTER_ISNOTNULL_MISSING_COLUMN  = 86,
  ERROR_SCAN_FILTER_UNKNOWN_OP = 87,
  ERROR_SCAN_FILTER_INVALID_COND = 88,
  ERROR_SCAN_INVALID_VALUE = 89,
  ERROR_SCAN_INDEX_MISSING_NAME = 90,
  ERROR_SCAN_INDEX_MISSING_COLUMNS = 91,
  ERROR_SCAN_INDEX_COLUMNS_NOT_ARRAY = 92,
  ERROR_SCAN_INDEX_COLUMN_INVALID = 93,
  ERROR_SCAN_INDEX_COLUMNS_EMPTY = 94,
  ERROR_SCAN_INDEX_ORDER_INVALID = 95,
  ERROR_SCAN_INDEX_MISSING_RANGES = 96,
  ERROR_SCAN_INDEX_RANGES_NOT_ARRAY = 97,
  ERROR_SCAN_INDEX_RANGE_INVALID = 98,
  ERROR_SCAN_INDEX_BOUND_INVALID = 99,
  ERROR_SCAN_INDEX_BOUND_MISSING_VALUES = 100,
  ERROR_SCAN_INDEX_BOUND_VALUES_NOT_ARRAY = 101,
...
static const ErrorEntry errorTable[] = {
    ...
    {ERROR_SCAN_FILTER_MISSING_OP, "[ScanFilter] Missing required field: op"},
    {ERROR_SCAN_FILTER_LOGIC_MISSING_FILTERS, "[ScanFilter] Missing required array field for the Logic op: filters"},
    {ERROR_SCAN_FILTER_LOGIC_INVALID_CHILD_TYPE, "[ScanFilter] Child filter field type for the logic op must be an object"},
    {ERROR_SCAN_FILTER_LOGIC_INVALID_CHILD_NUM, "[ScanFilter] Logic op must contain 2 children"},
    {ERROR_SCAN_FILTER_CMP_MISSING_COLUMN, "[ScanFilter] Missing required field for the cmp op: column"},
    ...
    {ERROR_SCAN_INDEX_MISSING_COLUMNS, "[ScanIndex] Missing index columns"},
    {ERROR_SCAN_INDEX_COLUMNS_NOT_ARRAY, "[ScanIndex] Columns must be array"},
    {ERROR_SCAN_INDEX_COLUMN_INVALID, "[ScanIndex] Columns must be string"},
    {ERROR_SCAN_INDEX_COLUMNS_EMPTY, "[ScanIndex] Columns cannot be empty"},
    {ERROR_SCAN_INDEX_ORDER_INVALID, "[ScanIndex] Order must be string: asc / desc"},
    {ERROR_SCAN_INDEX_MISSING_RANGES, "[ScanIndex] Missing index ranges"},
    {ERROR_SCAN_INDEX_RANGES_NOT_ARRAY, "[ScanIndex] Ranges must be array"},
    {ERROR_SCAN_INDEX_RANGE_INVALID, "[ScanIndex] Range must be object"},
    {ERROR_SCAN_INDEX_BOUND_INVALID, "[ScanIndex] Range bound must be object"},
    {ERROR_SCAN_INDEX_BOUND_MISSING_VALUES, "[ScanIndex] Range bound missing values"},
    {ERROR_SCAN_INDEX_BOUND_VALUES_NOT_ARRAY, "[ScanIndex] Range bound values must be array"},
