...
#define ZABORT_SETUP 1
#define ZCOMMIT_SETUP 2
#define ZCOMPLETE_SETUP 3
...
#define ZDIRTY_OPERATION_ERROR 2200
#endif
...
class Dbtc : public SimulatedBlock {
  ...
  */
  ...
  struct TcDefinedTriggerData {
    static constexpr Uint32 TYPE_ID = RT_DBTC_DEFINED_TRIGGER;
    Uint32 m_magic;
  ...
  static constexpr
    Uint32 DBTC_DEFINED_TRIGGER_RECORD_TRANSIENT_POOL_INDEX = 14;
  ...
  static constexpr Uint32 DBTC_COMMIT_ACK_MARKER_BUFFER_TRANSIENT_POOL_INDEX =
      1;
  typedef DataBuffer<5, CommitAckMarkerBuffer_pool,
  ...
  static constexpr Uint32 DBTC_INDEX_DATA_RECORD_TRANSIENT_POOL_INDEX = 13;
  ...
  struct ApiConnectRecord {
    ...
    Uint32 nextTcOperation;
    bool send_abort_done;
    bool setup_fail_data;
...
#define TRANSID_FAIL_HASH_SIZE 2048
  ...
  void updateApiStateFail(Signal *signal, Uint32 transid1, Uint32 transid2,
                          LqhTransConf::OperationStatus transStatus,
                          Uint32 reqinfo, BlockReference applRef, Uint64 gci,
                          NodeId nodeId, ApiConnectRecordPtr apiConnectptr);
  bool findTcConnectFail(Signal *signal, Uint32 transid1, Uint32 transid2,
                         Uint32 tcOprec, ApiConnectRecordPtr apiConnectptr);
  void initTcConnectFail(Signal *signal, Uint32 instanceKey, Uint32 tcOprec,
                         Uint32 reqinfo,
                         LqhTransConf::OperationStatus transStatus,
                         NodeId nodeId, Uint32 apiConnectPtr);
  void updateTcStateFail(Signal *signal, Uint32 instanceKey, Uint32 tcOprec,
                         Uint32 reqinfo,
                         LqhTransConf::OperationStatus transStatus,
                         NodeId nodeId, ApiConnectRecordPtr apiConnecptr);
  ...
  void handleFailedApiNode(Signal *signal, UintR aFailedNode,
  ...
  void time_track_complete_key_operation(TcConnectRecord *const tcConnectPtr,
                                         Uint32 apiNodeId, Uint32 dbNodeId);
  void time_track_complete_index_key_operation(
      TcConnectRecord *const tcConnectPtr, Uint32 apiNodeId, Uint32 dbNodeId);
  ...
  void time_track_complete_transaction_error(ApiConnectRecord *const regApiPtr);
 ...
 public:
  struct CommitAckMarker {
    ...
    CommitAckMarker()
        : m_magic(Magic::make(TYPE_ID)), apiConnectPtr(RNIL), apiNodeId(0) {}
    ...
    bool insert_in_commit_ack_marker(Dbtc *tc, Uint32 instanceKey,
                                     NodeId nodeId);
    // insert all keys when exact keys not known
    bool insert_in_commit_ack_marker_all(Dbtc *tc, NodeId nodeId);
  };
 ...
 private:
  ...
  void sendRemoveMarker(Signal *signal, NodeId nodeId, Uint32 instanceKey,
...
//#define DEBUG_QUERY_THREAD_USAGE
  ...
  void check_to_abort_handling(Signal *signal,
                               ...
                               Uint32 tcConnectPtrI,
                               Uint32 line);
  void send_to_commit_handling(Signal *signal,
                               ApiConnectRecordPtr const apiConnectptr,
                               Uint32 tcConnectPtrI,
                               Uint32 line);
  void check_to_commit_handling(Signal *signal,
                                ApiConnectRecordPtr const apiConnectptr,
                                Uint32 tcConnectPtrI,
                                Uint32 line);
  void send_to_complete_handling(Signal *signal,
                                 ApiConnectRecordPtr const apiConnectptr,
                                 Uint32 tcConnectPtrI,
                                 Uint32 line);
  void check_to_complete_handling(Signal *signal,
                                  ApiConnectRecordPtr const apiConnectptr,
                                  Uint32 tcConnectPtrI,
                                  Uint32 line);
  void send_abort_break(Signal *signal,
                        ApiConnectRecordPtr const apiConnectptr,
                        Uint32 tcConnectPtrI,
                        Uint32 line);

  void check_finished_abort_handling(Signal *signal,
                                     ApiConnectRecordPtr apiConnectptr);
  void check_finished_commit_handling(Signal *signal,
                                      ApiConnectRecordPtr apiConnectptr);
  ...
  void send_setupFailData(Signal *signal,
                          ...
                          Uint32 tcConnectPtrI,
                          Uint32 type);
  void init_setupFailData(Signal *signal,
                          ApiConnectRecordPtr const apiConnectptr,
                          Uint32 type);
  void checkFailData_abort(Signal *signal,
                           ApiConnectRecordPtr apiConnectptr);
  void checkFailData_commit(Signal *signal,
                            ApiConnectRecordPtr apiConnectptr);
  void checkFailData_complete(Signal *signal,
                              ApiConnectRecordPtr apiConnectptr);
...
inline
void
Dbtc::send_commit_loop(Signal *signal,
                       ApiConnectRecordPtr const apiConnectptr,
                       Uint32 tcConnectPtrI,
                       Uint32 line)
{
  /**
   * Make sure that we don't complete the transaction while we have
...
inline
void
Dbtc::send_complete_loop(Signal *signal,
                         ApiConnectRecordPtr const apiConnectptr,
                         Uint32 tcConnectPtrI,
                         Uint32 line)
{
...
inline
void
Dbtc::send_to_abort_handling(Signal *signal,
                             ApiConnectRecordPtr const apiConnectptr,
                             Uint32 tcConnectPtrI,
                             Uint32 line)
{
  ...
  setApiConTimer(apiConnectptr, ctcTimer, line);
  signal->theData[0] = TcContinueB::ZSEND_TO_ABORT_HANDLING;
  signal->theData[1] = apiConnectptr.i;
  signal->theData[2] = tcConnectPtrI;
  sendSignal(cownref, GSN_CONTINUEB, signal, 3, JBB);
  return;
...
inline
void
Dbtc::check_to_abort_handling(Signal *signal,
                              ApiConnectRecordPtr const apiConnectptr,
                              Uint32 tcConnectPtrI,
                              Uint32 line)
{
  ...
  apiConnectptr.p->finish_trans_counter++;
  setApiConTimer(apiConnectptr, ctcTimer, line);
  signal->theData[0] = TcContinueB::ZCHECK_TO_ABORT_HANDLING;
  signal->theData[1] = apiConnectptr.i;
  signal->theData[2] = tcConnectPtrI;
  sendSignal(cownref, GSN_CONTINUEB, signal, 3, JBB);
  return;
...
inline
void
Dbtc::send_to_commit_handling(Signal *signal,
                              ApiConnectRecordPtr const apiConnectptr,
                              Uint32 tcConnectPtrI,
                              Uint32 line)
{
  ...
  apiConnectptr.p->finish_trans_counter++;
  setApiConTimer(apiConnectptr, ctcTimer, line);
  signal->theData[0] = TcContinueB::ZSEND_TO_COMMIT_HANDLING;
  signal->theData[1] = apiConnectptr.i;
  signal->theData[2] = tcConnectPtrI;
  sendSignal(cownref, GSN_CONTINUEB, signal, 3, JBB);
  return;
...
inline
void
Dbtc::check_to_commit_handling(Signal *signal,
                               ApiConnectRecordPtr const apiConnectptr,
                               Uint32 tcConnectPtrI,
                               Uint32 line)
{
  ...
  apiConnectptr.p->finish_trans_counter++;
  setApiConTimer(apiConnectptr, ctcTimer, line);
  signal->theData[0] = TcContinueB::ZCHECK_TO_COMMIT_HANDLING;
  signal->theData[1] = apiConnectptr.i;
  signal->theData[2] = tcConnectPtrI;
  sendSignal(cownref, GSN_CONTINUEB, signal, 3, JBB);
  return;
...
inline
void
Dbtc::send_to_complete_handling(Signal *signal,
                                ApiConnectRecordPtr const apiConnectptr,
                                Uint32 tcConnectPtrI,
                                Uint32 line)
{
  ...
  apiConnectptr.p->finish_trans_counter++;
  setApiConTimer(apiConnectptr, ctcTimer, line);
  signal->theData[0] = TcContinueB::ZSEND_TO_COMPLETE_HANDLING;
  signal->theData[1] = apiConnectptr.i;
  signal->theData[2] = tcConnectPtrI;
  sendSignal(cownref, GSN_CONTINUEB, signal, 3, JBB);
  return;
...
inline
void
Dbtc::check_to_complete_handling(Signal *signal,
                                 ApiConnectRecordPtr const apiConnectptr,
                                 Uint32 tcConnectPtrI,
                                 Uint32 line)
{
  ...
  apiConnectptr.p->finish_trans_counter++;
  setApiConTimer(apiConnectptr, ctcTimer, line);
  signal->theData[0] = TcContinueB::ZCHECK_TO_COMPLETE_HANDLING;
  signal->theData[1] = apiConnectptr.i;
  signal->theData[2] = tcConnectPtrI;
  sendSignal(cownref, GSN_CONTINUEB, signal, 3, JBB);
  return;
...
inline
void
Dbtc::send_abort_break(Signal* signal,
                       ApiConnectRecordPtr const apiConnectptr,
                       Uint32 tcConnectPtrI,
                       Uint32 line)
{
