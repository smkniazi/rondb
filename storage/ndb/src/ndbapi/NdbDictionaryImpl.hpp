...
bool is_ndb_blob_table(const char *name, Uint32 *ptab_id = nullptr,
...
class NdbDictObjectImpl {
 ...
 protected:
  ...
  NdbDictObjectImpl(NdbDictionary::Object::Type type)
      : m_type(type), m_status(NdbDictionary::Object::New) {
    m_id = -1;
  }
};
...
class NdbTableImpl : public NdbDictionary::Table, public NdbDictObjectImpl {
 public:
  ...
  int setExtraMetadata(Uint32 version, const void *data, Uint32 data_length);
  int getExtraMetadata(Uint32 &extra_metadata_version, void **data,
...
class NdbOptimizeTableHandleImpl : public NdbDictionary::OptimizeTableHandle {
 ...
 public:
  ...
  ~NdbOptimizeTableHandleImpl();
  static NdbOptimizeTableHandleImpl &getImpl(
      NdbDictionary::OptimizeTableHandle &h) {
    return h.m_impl;
  }
...
class NdbOptimizeIndexHandleImpl : public NdbDictionary::OptimizeIndexHandle {
 ...
 public:
  ...
  ~NdbOptimizeIndexHandleImpl();
  static NdbOptimizeIndexHandleImpl &getImpl(
...
class NdbLogfileGroupImpl : public NdbDictionary::LogfileGroup,
 ...
 public:
  ...
  static const NdbLogfileGroupImpl &getImpl(
      const NdbDictionary::LogfileGroup &);
...
class NdbHashMapImpl : public NdbDictionary::HashMap, public NdbDictObjectImpl {
 public:
  ...
  static NdbHashMapImpl &getImpl(NdbDictionary::HashMap &t) { return t.m_impl; }
...
class NdbDictInterface {
 public:
  ...
  struct Tx {
    ...
    Uint32 m_requestId;
    Vector<Op> m_op;
    Tx() : m_state(NotStarted), m_transId(0), m_transKey(0), m_requestId(0) {
      m_error.code = 0;
    }
    Uint32 transId() const { return (m_state == Started) ? m_transId : 0; }
    Uint32 transKey() const { return (m_state == Started) ? m_transKey : 0; }
    Uint32 nextRequestId() { return ++m_requestId; }
    bool checkRequestId(Uint32 requestId,
      ...
      if (m_requestId != 0 && m_requestId != requestId) {
        ...
        DBUG_PRINT(
            "info",
            ("Discarding %s with bad request ID, expected: %u, received: %u",
             signalName, m_requestId, requestId));
        return false;
      }
      return true;
    }
  ...
  int dictSignal(NdbApiSignal *signal, LinearSectionPtr ptr[3], int secs,
                 ...
                 Uint32 waitsignaltype, int timeout, Uint32 RETRIES,
  ...
  int compChangeMask(const NdbTableImpl &old_impl, const NdbTableImpl &impl,
                     Uint32 &change_mask);
  int serializeTableDesc(NdbTableImpl &impl, UtilBufferWriter &w);
  int sendAlterTable(const NdbTableImpl &impl, Uint32 change_mask);
  int sendCreateTable();

  int dropTable(const NdbTableImpl &);

  int createIndex(const NdbIndexImpl &, const NdbTableImpl &, bool offline);
  ...
  NdbTableImpl *getTable(class NdbApiSignal *signal, LinearSectionPtr ptr[3],
                         Uint32 noOfSections);
  ...
  static int parseHashMapInfo(NdbHashMapImpl &dst, const Uint32 *data,
                              Uint32 len);

  static int parseForeignKeyInfo(NdbForeignKeyImpl &dst, const Uint32 *data,
                                 Uint32 len);
  ...
  int get_filegroup(NdbFilegroupImpl &, NdbDictionary::Object::Type,
                    const char *);
 ...
 private:
  ...
  friend class NdbDictionaryImpl;
  static void execSignal(void *dictImpl, const class NdbApiSignal *signal,
  ...
  void execLIST_TABLES_CONF(const NdbApiSignal *,
...
class GlobalCacheInitObject {
 public:
  ...
  GlobalCacheInitObject(const BaseString &name) : m_name(name) {}
...
class NdbDictionaryImpl : public NdbDictionary::Dictionary {
 public:
  ...
  int dropIndex(const char *indexName, const char *tableName, bool ignoreFKs);
  ...
  int initialiseColumnData(bool isIndex, Uint32 flags,
                           const NdbDictionary::RecordSpecification *recSpec,
                           Uint32 colNum, NdbRecord *rec);
  ...
  NdbRecord *createRecord(const NdbTableImpl *table,
                          ...
                          bool defaultRecord);
  NdbRecord *createRecordInternal(
      const NdbTableImpl *table,
  ...
  static bool getNextAttrIdFrom(const NdbRecord *record, Uint32 startAttrId,
                                Uint32 &nextAttrId);
  static bool getOffset(const NdbRecord *record, Uint32 attrId, Uint32 &offset);
  static bool getNullBitOffset(const NdbRecord *record, Uint32 attrId,
                               Uint32 &nullbit_byte_offset,
                               Uint32 &nullbit_bit_in_byte);
  static const char *getValuePtr(const NdbRecord *record, const char *row,
                                 Uint32 attrId);
  ...
  static int setNull(const NdbRecord *record, char *row, Uint32 attrId,
                     bool value);
...
inline NdbEventImpl &NdbEventImpl::getImpl(const NdbDictionary::Event &t) {
  return t.m_impl;
}

inline NdbEventImpl &NdbEventImpl::getImpl(NdbDictionary::Event &t) {
  return t.m_impl;
}

inline NdbColumnImpl &NdbColumnImpl::getImpl(NdbDictionary::Column &t) {
  return t.m_impl;
}

inline const NdbColumnImpl &NdbColumnImpl::getImpl(
    const NdbDictionary::Column &t) {
  return t.m_impl;
}

inline bool NdbColumnImpl::getInterpretableType() const {
  return (m_type == NdbDictionary::Column::Unsigned ||
          m_type == NdbDictionary::Column::Bigunsigned);
}

inline bool NdbColumnImpl::getCharType() const {
...
inline bool NdbColumnImpl::getStringType() const {
  return (m_type == NdbDictionary::Column::Char ||
          m_type == NdbDictionary::Column::Varchar ||
          m_type == NdbDictionary::Column::Longvarchar ||
...
inline bool NdbColumnImpl::getBlobType() const {
  return (m_type == NdbDictionary::Column::Blob ||
          m_type == NdbDictionary::Column::Text);
}

inline int NdbColumnImpl::getBlobVersion() const { return m_blobVersion; }

inline void NdbColumnImpl::setBlobVersion(int blobVersion) {
...
inline bool NdbColumnImpl::get_var_length(const void *value,
                                          Uint32 &len) const {
...
inline NdbTableImpl &NdbTableImpl::getImpl(NdbDictionary::Table &t) {
  return t.m_impl;
}

inline NdbTableImpl &NdbTableImpl::getImpl(const NdbDictionary::Table &t) {
  return t.m_impl;
}

inline NdbColumnImpl *NdbTableImpl::getColumn(unsigned attrId) {
...
inline const char *NdbTableImpl::getMysqlName() const {
  return m_mysqlName.c_str();
}

inline bool NdbTableImpl::matchDb(const char *name, size_t len) const {
  return len < m_internalName.length() &&
         memcmp(name, m_internalName.c_str(), len) == 0;
}

static const Uint32 ColNameHashThresh = 5;

inline NdbColumnImpl *NdbTableImpl::getColumn(const char *name) {
...
inline const NdbColumnImpl *NdbTableImpl::getColumn(const char *name) const {
...
inline NdbIndexImpl &NdbIndexImpl::getImpl(const NdbDictionary::Index &t) {
  return t.m_impl;
}

inline NdbDictionaryImpl &NdbDictionaryImpl::getImpl(
    NdbDictionary::Dictionary &t) {
  return t.m_impl;
}

inline const NdbDictionaryImpl &NdbDictionaryImpl::getImpl(
    const NdbDictionary::Dictionary &t) {
  return t.m_impl;
}
...
class InitTable : public GlobalCacheInitObject {
 public:
  InitTable(const BaseString &name) : GlobalCacheInitObject(name) {}
  int init(NdbDictionaryImpl *dict, NdbTableImpl &tab) const override {
    int res = dict->getBlobTables(tab);
    if (res == 0) res = dict->createDefaultNdbRecord(&tab, nullptr);

    return res;
  }
};

inline NdbTableImpl *NdbDictionaryImpl::getTableGlobal(const char *table_name) {
  ...
  if (!checkDatabaseAndSchemaName()) return nullptr;
...
inline NdbTableImpl *NdbDictionaryImpl::getTable(const char *table_name,
                                                 void **data) {
  ...
  // Don't allow opening table without database or schema name specified,
  // the internal name format depends on those to be set
  if (!checkDatabaseAndSchemaName()) DBUG_RETURN(nullptr);

  const BaseString internal_tabname(m_ndb.internalize_table_name(table_name));
  Ndb_local_table_info *info = get_local_table_info(internal_tabname);
  if (info == nullptr) DBUG_RETURN(nullptr);
  if (data) *data = info->m_local_data;
  DBUG_RETURN(info->m_table_impl);
}

inline Ndb_local_table_info *NdbDictionaryImpl::get_local_table_info(
    const BaseString &internalTableName) {
...
class InitIndex : public GlobalCacheInitObject {
 public:
  ...
  InitIndex(const BaseString &internal_indexname, const char *index_name,
  ...
  int init(NdbDictionaryImpl *dict, NdbTableImpl &tab) const override {
     ...
     */
    NdbIndexImpl *idx;
    if (NdbDictInterface::create_index_obj_from_table(&idx, &tab, &m_prim) ==
        0) {
      idx->m_table = &tab;
...
inline NdbIndexImpl *NdbDictionaryImpl::getIndexGlobal(const char *index_name,
                                                       NdbTableImpl &ndbtab) {
  DBUG_ENTER("NdbDictionaryImpl::getIndexGlobal");

  const BaseString internal_indexname(
      NdbIndexImpl::internal_index_name(&ndbtab, index_name));
  int retry = 2;

  while (retry) {
    NdbTableImpl *tab = fetchGlobalTableImplRef(
        InitIndex(internal_indexname, index_name, ndbtab));
    if (tab) {
  ...
  }
  {
    ...
    const BaseString old_internal_indexname(
        NdbIndexImpl::old_internal_index_name(&ndbtab, index_name));
    retry = 2;
    while (retry) {
      NdbTableImpl *tab = fetchGlobalTableImplRef(
          InitIndex(old_internal_indexname, index_name, ndbtab));
      if (tab) {
        // tab->m_index should be set. otherwise tab == 0
        NdbIndexImpl *idx = tab->m_index;
        if (idx->m_table_id != (unsigned)ndbtab.getObjectId() ||
  ...
  if (m_error.code == 0 || m_error.code == 723) m_error.code = 4243;
  DBUG_RETURN(nullptr);
}

inline NdbIndexImpl *NdbDictionaryImpl::getIndexGlobal(const char *indexName,
                                                       const char *tableName) {
  DBUG_ENTER("NdbDictionaryImpl::getIndexGlobal");
  NdbTableImpl *t = getTableGlobal(tableName);
  if (t == nullptr) DBUG_RETURN(nullptr);
  DBUG_RETURN(getIndexGlobal(indexName, *t));
}

inline int NdbDictionaryImpl::releaseTableGlobal(const NdbTableImpl &impl,
                                                 int invalidate) {
...
inline int NdbDictionaryImpl::releaseIndexGlobal(const NdbIndexImpl &impl,
                                                 int invalidate) {
...
inline NdbIndexImpl *NdbDictionaryImpl::getIndex(const char *index_name,
...
inline NdbIndexImpl *NdbDictionaryImpl::getIndex(const char *index_name,
                                                 const NdbTableImpl &prim) {
  const BaseString internal_indexname(
      NdbIndexImpl::internal_index_name(&prim, index_name));
...
inline NdbTablespaceImpl &NdbTablespaceImpl::getImpl(
    NdbDictionary::Tablespace &t) {
  return t.m_impl;
}

inline const NdbTablespaceImpl &NdbTablespaceImpl::getImpl(
    const NdbDictionary::Tablespace &t) {
  return t.m_impl;
}

inline NdbLogfileGroupImpl &NdbLogfileGroupImpl::getImpl(
    NdbDictionary::LogfileGroup &t) {
  return t.m_impl;
}

inline const NdbLogfileGroupImpl &NdbLogfileGroupImpl::getImpl(
    const NdbDictionary::LogfileGroup &t) {
  return t.m_impl;
}

inline NdbDatafileImpl &NdbDatafileImpl::getImpl(NdbDictionary::Datafile &t) {
  return t.m_impl;
}

inline const NdbDatafileImpl &NdbDatafileImpl::getImpl(
    const NdbDictionary::Datafile &t) {
  return t.m_impl;
}

inline NdbUndofileImpl &NdbUndofileImpl::getImpl(NdbDictionary::Undofile &t) {
  return t.m_impl;
}

inline const NdbUndofileImpl &NdbUndofileImpl::getImpl(
    const NdbDictionary::Undofile &t) {
  return t.m_impl;
}
