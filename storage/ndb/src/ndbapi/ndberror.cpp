...
ErrorBundle ErrorCodes[] = {
  ...
  { 849,  DMEC, AE, "Longlong string too long" },
  ...
  { 853,  DMEC, AE, "Invalid Longlong string" },
  { 854,  DMEC, AE, "Calculation resulted in overflow" },
  { 855,  DMEC, AE, "Convert longlong to string failed" },
  ...
  {  730,  DMEC, TR, "Busy during read of event table, out of prepare records"},
  {  731,  DMEC, TR, "Busy during read of event table, out of prepare pages"},
  {  748,  DMEC, TR, "Busy during read of event table, out of prepare operations"},
  ...
  { 918,  DMEC, TR, "Cannot prepare index stats update, out of prepare op records" },
  ...
  { 4343, DMEC, AE, "Table with blobs does not support refresh" },
  ...
  { 4562, DMEC, AE, "Pushdown aggregation can only work with version >= 24.10.0" },
  ...
  { 4566, DMEC, AE, "Using partial read is only accessible for varbinary and longvarbinary columns" },
  { 4567, DMEC, AE, "Using append in setValueExt is only accessible for varbinary and longvarbinary columns" },
