...
const GsnName SignalNames [] = {
  ...
  ,{ GSN_API_BROADCAST_REP, "API_BROADCAST_REP" }
  ,{ GSN_CREATE_DATABASE_REQ, "CREATE_DATABASE_REQ" }
  ,{ GSN_CREATE_DATABASE_REF, "CREATE_DATABASE_REF" }
  ,{ GSN_CREATE_DATABASE_CONF, "CREATE_DATABASE_CONF" }
  ,{ GSN_CREATE_DB_REQ, "CREATE_DB_REQ" }
  ,{ GSN_CREATE_DB_REF, "CREATE_DB_REF" }
  ,{ GSN_CREATE_DB_CONF, "CREATE_DB_CONF" }
  ,{ GSN_DROP_DATABASE_REQ, "DROP_DATABASE_REQ" }
  ,{ GSN_DROP_DATABASE_REF, "DROP_DATABASE_REF" }
  ,{ GSN_DROP_DATABASE_CONF, "DROP_DATABASE_CONF" }
  ,{ GSN_DROP_DB_REQ, "DROP_DB_REQ" }
  ,{ GSN_DROP_DB_REF, "DROP_DB_REF" }
  ,{ GSN_DROP_DB_CONF, "DROP_DB_CONF" }
  ,{ GSN_ALTER_DATABASE_REQ, "ALTER_DATABASE_REQ" }
  ,{ GSN_ALTER_DATABASE_REF, "ALTER_DATABASE_REF" }
  ,{ GSN_ALTER_DATABASE_CONF, "ALTER_DATABASE_CONF" }
  ,{ GSN_ALTER_DB_REQ, "ALTER_DB_REQ" }
  ,{ GSN_ALTER_DB_REF, "ALTER_DB_REF" }
  ,{ GSN_ALTER_DB_CONF, "ALTER_DB_CONF" }
  ,{ GSN_CONNECT_TABLE_DB_REQ, "CONNECT_TABLE_DB_REQ" }
  ,{ GSN_CONNECT_TABLE_DB_CONF, "CONNECT_TABLE_DB_CONF" }
  ,{ GSN_CONNECT_TABLE_DB_REF, "CONNECT_TABLE_DB_REF" }
  ,{ GSN_COMMIT_DB_REQ, "COMMIT_DB_REQ" }
  ,{ GSN_COMMIT_DB_CONF, "COMMIT_DB_CONF" }
  ,{ GSN_COMMIT_DB_REF, "COMMIT_DB_REF" }
  ,{ GSN_DISCONNECT_TABLE_DB_REQ, "DISCONNECT_TABLE_DB_REQ" }
  ,{ GSN_DISCONNECT_TABLE_DB_CONF, "DISCONNECT_TABLE_DB_CONF" }
  ,{ GSN_DISCONNECT_TABLE_DB_REF, "DISCONNECT_TABLE_DB_REF" }
  ,{ GSN_GET_DATABASE_REQ, "GET_DATABASE_REQ" }
  ,{ GSN_GET_DATABASE_REF, "GET_DATABASE_REF" }
  ,{ GSN_GET_DATABASE_CONF, "GET_DATABASE_CONF" }
  ,{ GSN_LIST_DATABASE_REQ, "LIST_DATABASE_REQ" }
  ,{ GSN_LIST_DATABASE_REF, "LIST_DATABASE_REF" }
  ,{ GSN_LIST_DATABASE_CONF, "LIST_DATABASE_CONF" }
  ,{ GSN_DATABASE_QUOTA_REP, "DATABASE_QUOTA_REP" }
  ,{ GSN_DATABASE_RATE_ORD, "DATABASE_RATE_ORD" }
  ,{ GSN_RATE_OVERLOAD_REP, "RATE_OVERLOAD_REP" }
  ,{ GSN_QUOTA_OVERLOAD_REP, "QUOTA_OVERLOAD_REP" }
