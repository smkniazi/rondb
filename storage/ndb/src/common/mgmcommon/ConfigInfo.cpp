...
const ConfigInfo::ParamInfo ConfigInfo::m_ParamInfo[] = {
    ...
    {CFG_DB_NO_ATTRIBUTES, "MaxNoOfAttributes", DB_TOKEN,
     ...
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT, "0", "32",
     STR_VALUE(MAX_INT_RNIL)},
    ...
    {/**
     ...
     ConfigInfo::CI_STRING, "LatencyOptimisedSpinning", nullptr, nullptr},
    ...
    {CFG_DB_SCHED_RESPONSIVENESS, "SchedulerResponsiveness", DB_TOKEN,
     ...
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT, "9", "0", "10"},
 ...
 
  {
    ...
    {CFG_DB_GCP_TIMEOUT, "TimeBetweenGlobalCheckpointsTimeout", DB_TOKEN,
     ...
     /*
       ...
       stop.
     */
     ConfigInfo::CI_USED, 0, ConfigInfo::CI_INT, "120000", "3000",
     STR_VALUE(MAX_INT_RNIL)},
    ...
    {CFG_DB_MAX_BUFFERED_EPOCH_BYTES, "MaxBufferedEpochBytes", DB_TOKEN,
     ...
     ConfigInfo::CI_USED, 0, ConfigInfo::CI_INT, "500M", "26214400",
     STR_VALUE(MAX_INT_RNIL)},
    ...
    {CFG_DB_THREAD_POOL, "DiskIOThreadPool", DB_TOKEN,
     ...
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT, "8", "0",
     STR_VALUE(MAX_INT_RNIL)},
    ...
    {CFG_DB_MIN_DISK_WRITE_SPEED, "MinDiskWriteSpeed", DB_TOKEN,
     ...
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT64, "2M", "1M", "1024G"},
    ...
    {CFG_DB_MAX_DISK_WRITE_SPEED, "MaxDiskWriteSpeed", DB_TOKEN,
     ...
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT64, "4M", "1M", "1024G"},
    ...
    {CFG_DB_STRING_MEMORY, "StringMemory", DB_TOKEN,
     ...
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT,
     STR_VALUE(DEFAULT_STRING_MEMORY), "0", STR_VALUE(MAX_INT_RNIL)},
    ...
    {CFG_DB_FREE_PCT, "MinFreePct", DB_TOKEN,
     ...
     "during restart",
     ConfigInfo::CI_USED, false, ConfigInfo::CI_INT, "5", "0", "20"},
  ...
  /* End RonDB additions */
    ...
    {CFG_TCP_SEND_BUFFER_SIZE, "SendBufferMemory", "TCP",
     ...
     false, ConfigInfo::CI_INT, "8M", "64K", STR_VALUE(MAX_INT_RNIL)},
