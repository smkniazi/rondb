...
| FV Metadata Cache | `claude_files/fv_metadata_cache/` | Feature View metadata cache in RDRS2: architecture, threading, RONDB-1030 fixes |
...
- `architecture.md` — Cache design: entry states, threading model, lock ordering, preload vs lazy-load paths, reference counting, eviction strategies
- `rondb_1030_fixes.md` — RONDB-1030 race condition fixes: error eviction, deferred retry with backoff, event loop starvation cap, test coverage
